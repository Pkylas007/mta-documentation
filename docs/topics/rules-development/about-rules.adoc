...
[role="_abstract"]
The {ProductFullName} contains rule-based migration tools called the analyzer that use pluggable providers to analyze static code, dependencies, and other files in your application. 
