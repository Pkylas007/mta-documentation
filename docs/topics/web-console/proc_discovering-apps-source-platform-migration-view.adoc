...
. Click *Add a name* to enter one application per text field and click *+* to add many applications. For example, app-a.

. Click *Add a space* to enter one space per text field and click *+* to add many spaces. For example, space1.

. Click *Add an organization* to enter one organization per text field and click *+* to add many organizations. For example, org1.
+
